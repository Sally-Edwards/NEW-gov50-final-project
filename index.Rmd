...
First, we calculate the average view toward immigration for individuals living in El Paso. We can then compare that to the distribution of Immigration ideologies across the study through plotting the mean onto a histogram distribution of the survey results. 
